...
function EditPost() {
    ...
    const getPostById = async() => {
        ...
        const response = await axios.get(`http://localhost:2000/api/postingan/${id}`);
        //get response data
    ...
    //function "updatePostingan"
    const updatePostingan = async (e) => {
        e.preventDefault();
        
        //send data to server
        await axios.patch(`http://localhost:2000/api/postingan/updatePostingan/${id}`, {
            title: title,
            content: content
        })
        .then(() => {
