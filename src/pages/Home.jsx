            ...
            <Row>
                <Col md="{12}">
                    <Card className="border-0 rounded shadow-sm">
                        ...
                        <Button className="mt-2 rounded-pill" size="sm" onClick={() => setukuran("h1")}>h1</Button>
                        <Button className="mt-2 rounded-pill" size="sm" onClick={() => setukuran("h2")}>h2</Button>
                        <Button className="mt-2 rounded-pill" size="sm" onClick={() => setukuran("h3")}>h3</Button>
